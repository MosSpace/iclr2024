...
csv_save_path = "/mnt/bn/lqhaoheliu/audio_samples_mos/music/input.csv"

testfilelist = read_list("/mnt/bn/lqhaoheliu/audio_samples_mos/music/filename_v2.lst")
...
rows = []
root_path = "/mnt/bn/lqhaoheliu/audio_samples_mos/music"
for folder in os.listdir(root_path):
    if(not os.path.isdir(os.path.join(root_path, folder))): 
        continue

    remote_url = os.path.join("https://github.com/MosSpace/iclr2024/raw/main/","music", folder)
